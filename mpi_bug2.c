...
/******************************************************************************
* Irena's comments
* The data types are wrong - data type of message sent doesn't match the data type what receiver expects 
* change float beta to int beta and also edit printf content
******************************************************************************/
#include "mpi.h"
#include <stdio.h>
#include <stdlib.h>
