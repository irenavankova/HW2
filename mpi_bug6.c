...
/******************************************************************************
* Irena's comments
* reqs index seems to overlap due to bad setting of offset, setting initial offset
to 0 for all fixes it
* mpi_waitall gives error as the number of requests is wrong, e.g. processor 2 can't wait for 2000
requests since it uses only send not isend - need to set that to 0
******************************************************************************/
#include "mpi.h"
#include <stdio.h>
#include <stdlib.h>
