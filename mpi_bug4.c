...
/******************************************************************************
* Irena's comments
* Initialized array sum and Final sum are identical
* The problem is that MASTER does not contain the reduce command
* It was not contributing to the total sum and was just printing initialized
* not the updated sum
******************************************************************************/
